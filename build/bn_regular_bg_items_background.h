...
//
//	Time-stamp: 2023-02-03, 08:12:51
...
#define background_bn_gfxTilesLen 1984
extern const bn::tile background_bn_gfxTiles[62];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item background(
            regular_bg_tiles_item(span<const tile>(background_bn_gfxTiles, 62), bpp_mode::BPP_4, compression_type::NONE), 
